...
class YesNoModel {
  ...
  YesNoModel({required this.data, required this.meta});
  ...
  Message toMessageEntity({required bool isYes}) {
    return Message(
      text: isYes ? 'Sí 😊' : 'No 🙁',
